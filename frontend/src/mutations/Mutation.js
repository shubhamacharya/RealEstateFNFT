...
export const MINT_RNFT = "mutation mintNFT($name:String!,$images:[String]!,$docs:String!,$price:Float!,$ownerAddress:String!) {mintNFT(name:$name,images:$images,price:$price,ownerAddress:$ownerAddress,docs:$docs){txId}}";
